...
1. Download the [wardend binary v1.0.0](https://github.com/warden-protocol/wardenprotocol/releases/tag/v1.0.0) or build it from the source code. See the installation instructions in the [Join Barra guide](../join-barra#1-install-the-binary).
