...
// source: wardenprotocol/identity/space.proto
...
type Space struct {
	...
	ChildSpaces []string `protobuf:"bytes,4,rep,name=child_spaces,json=childSpaces,proto3" json:"child_spaces,omitempty"`
...
func (*Space) Descriptor() ([]byte, []int) {
	return fileDescriptor_1ab04a26a2379a67, []int{0}
}
...
func (m *Space) GetChildSpaces() []string {
	if m != nil {
		return m.ChildSpaces
	}
	return nil
}
...
func init() {
	proto.RegisterType((*Space)(nil), "wardenprotocol.identity.Space")
}

func init() {
	proto.RegisterFile("wardenprotocol/identity/space.proto", fileDescriptor_1ab04a26a2379a67)
}

var fileDescriptor_1ab04a26a2379a67 = []byte{
	// 260 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Space) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChildSpaces) > 0 {
		for iNdEx := len(m.ChildSpaces) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ChildSpaces[iNdEx])
			copy(dAtA[i:], m.ChildSpaces[iNdEx])
			i = encodeVarintSpace(dAtA, i, uint64(len(m.ChildSpaces[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *Space) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChildSpaces", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChildSpaces = append(m.ChildSpaces, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
