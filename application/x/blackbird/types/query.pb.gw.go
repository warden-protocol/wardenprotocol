...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"blackbird", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Verify_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"blackbird", "verify", "policy", "payload"}, "", runtime.AssumeColonVerbOpt(true)))
)
