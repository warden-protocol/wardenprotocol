...
The [`x/evm` Warden module](/learn/external-modules#xevm) allows executing **Ethereum Virtual Machine (EVM)** contracts charged by [Cosmos EVM](https://evm.cosmos.network) (former Evmos) and written in **Solidity**.
