...
exports.akashToEth = exports.ethToAkash = exports.AKASH = exports.kyveToEth = exports.ethToKyve = exports.KYVE = exports.cosmosToEth = exports.ethToCosmos = exports.COSMOS = exports.osmosisToEth = exports.ethToOsmosis = exports.OSMOSIS = exports.evmosToEth = exports.ethToEvmos = exports.EVMOS = exports.ethermintToEth = exports.ethToEthermint = exports.ETHERMINT = exports.ETH = void 0;
...
exports.AKASH = bech32Chain('AKASH', 'akash');
const ethToAkash = (ethAddress) => {
    const data = exports.ETH.decoder(ethAddress);
    return exports.AKASH.encoder(data);
};
exports.ethToAkash = ethToAkash;
const akashToEth = (akashAddress) => {
    const data = exports.AKASH.decoder(akashAddress);
    return exports.ETH.encoder(data);
};
exports.akashToEth = akashToEth;
