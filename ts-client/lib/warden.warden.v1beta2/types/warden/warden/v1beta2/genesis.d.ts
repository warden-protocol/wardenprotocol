...
export declare const GenesisState: {
    ...
    fromPartial<I_1 extends {
        ...
        params?: {} & {} & { [K_16 in Exclude<keyof I_1["params"], never>]: never; };
        keychains?: {
            id?: number;
            creator?: string;
            description?: string;
            ...
            creator?: string;
            description?: string;
            admins?: string[] & string[] & { [K_17 in Exclude<keyof I_1["keychains"][number]["admins"], keyof string[]>]: never; };
            parties?: string[] & string[] & { [K_18 in Exclude<keyof I_1["keychains"][number]["parties"], keyof string[]>]: never; };
            adminIntentId?: number;
            fees?: {
                keyReq?: number;
                sigReq?: number;
                ...
                keyReq?: number;
                sigReq?: number;
            } & { [K_19 in Exclude<keyof I_1["keychains"][number]["fees"], keyof import("./keychain").KeychainFees>]: never; };
            isActive?: boolean;
        } & { [K_20 in Exclude<keyof I_1["keychains"][number], keyof Keychain>]: never; })[] & { [K_21 in Exclude<keyof I_1["keychains"], keyof {
            id?: number;
            creator?: string;
            description?: string;
            admins?: string[];
        ...
        spaces?: {
            ...
            id?: number;
            creator?: string;
            owners?: string[] & string[] & { [K_22 in Exclude<keyof I_1["spaces"][number]["owners"], keyof string[]>]: never; };
            adminIntentId?: number;
            signIntentId?: number;
        } & { [K_23 in Exclude<keyof I_1["spaces"][number], keyof Space>]: never; })[] & { [K_24 in Exclude<keyof I_1["spaces"], keyof {
            id?: number;
            creator?: string;
            owners?: string[];
            adminIntentId?: number;
        ...
        keys?: {
            ...
            publicKey?: Uint8Array;
            intentId?: number;
        } & { [K_25 in Exclude<keyof I_1["keys"][number], keyof Key>]: never; })[] & { [K_26 in Exclude<keyof I_1["keys"], keyof {
            id?: number;
            spaceId?: number;
            keychainId?: number;
            type?: import("./key").KeyType;
        ...
        keyRequests?: {
            ...
            rejectReason?: string;
            intentId?: number;
        } & { [K_27 in Exclude<keyof I_1["keyRequests"][number], keyof KeyRequest>]: never; })[] & { [K_28 in Exclude<keyof I_1["keyRequests"], keyof {
            id?: number;
            creator?: string;
            spaceId?: number;
            keychainId?: number;
        ...
        signatureRequests?: {
            ...
            signedData?: Uint8Array;
            rejectReason?: string;
        } & { [K_29 in Exclude<keyof I_1["signatureRequests"][number], keyof SignRequest>]: never; })[] & { [K_30 in Exclude<keyof I_1["signatureRequests"], keyof {
            id?: number;
            creator?: string;
            keyId?: number;
            dataForSigning?: Uint8Array;
