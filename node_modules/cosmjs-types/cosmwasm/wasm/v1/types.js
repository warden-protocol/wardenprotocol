...
function createBaseParams() {
    return { codeUploadAccess: undefined, instantiateDefaultPermission: 0, maxWasmCodeSize: long_1.default.UZERO };
}
exports.Params = {
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    fromJSON(object) {
        return {
            ...
            instantiateDefaultPermission: isSet(object.instantiateDefaultPermission)
                ...
                : 0,
            maxWasmCodeSize: isSet(object.maxWasmCodeSize) ? long_1.default.fromValue(object.maxWasmCodeSize) : long_1.default.UZERO,
        };
    },
    toJSON(message) {
        const obj = {};
...
function createBaseContractCodeHistoryEntry() {
    return { operation: 0, codeId: long_1.default.UZERO, updated: undefined, msg: new Uint8Array() };
}
