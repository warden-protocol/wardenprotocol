...
// @generated from file fusionchain/blackbird/action.proto (package fusionchain.blackbird, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message fusionchain.blackbird.Action
 */
export class Action extends Message<Action> {
  ...
  static readonly typeName = "fusionchain.blackbird.Action";
