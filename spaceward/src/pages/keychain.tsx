...
function Keychain() {
    const { keychainId } = useLoaderData() as Awaited<
        ...
        <div className="hidden h-full flex-1 flex-col space-y-8 p-8 md:flex">
            <Breadcrumb>
                ...
                <BreadcrumbItem isCurrentPage>
                    <BreadcrumbLink to={`/keychains/${keychainId}`}>
                        {keychainId}
                    </BreadcrumbLink>
                </BreadcrumbItem>
            </Breadcrumb>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid w-full items-center gap-4">
                        <CardRow label="Description">{kr.description}</CardRow>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        These accounts will be allowed to respond to keys and
                        signatures requests for this keychain.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid w-full items-center gap-4">
                        <ul className="flex flex-col space-y-1">
                            {kr.parties.map((p) => (
                                <li
                                    key={p}
                                    className="list-disc list-inside group"
                                >
                                    <Address address={p} />
