...
// source: wardenprotocol/treasury/signature.proto
...
func (SignRequestStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_614d6d7b3baa0c69, []int{0}
}
...
type SignRequest struct {
	...
	Status         SignRequestStatus `protobuf:"varint,5,opt,name=status,proto3,enum=wardenprotocol.treasury.SignRequestStatus" json:"status,omitempty"`
	KeyType        KeyType           `protobuf:"varint,8,opt,name=key_type,json=keyType,proto3,enum=wardenprotocol.treasury.KeyType" json:"key_type,omitempty"`
...
type SignTransactionRequest struct {
	...
	Creator             string     `protobuf:"bytes,2,opt,name=creator,proto3" json:"creator,omitempty"`
	KeyId               uint64     `protobuf:"varint,3,opt,name=key_id,json=keyId,proto3" json:"key_id,omitempty"`
	WalletType          WalletType `protobuf:"varint,4,opt,name=wallet_type,json=walletType,proto3,enum=wardenprotocol.treasury.WalletType" json:"wallet_type,omitempty"`
...
func (*SignTransactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_614d6d7b3baa0c69, []int{1}
}
...
func init() {
	proto.RegisterEnum("wardenprotocol.treasury.SignRequestStatus", SignRequestStatus_name, SignRequestStatus_value)
	proto.RegisterType((*SignRequest)(nil), "wardenprotocol.treasury.SignRequest")
	proto.RegisterType((*SignTransactionRequest)(nil), "wardenprotocol.treasury.SignTransactionRequest")
}

func init() {
	proto.RegisterFile("wardenprotocol/treasury/signature.proto", fileDescriptor_614d6d7b3baa0c69)
}

var fileDescriptor_614d6d7b3baa0c69 = []byte{
	// 535 bytes of a gzipped FileDescriptorProto
	,
}
