...
export { Vote, QueryVotesRequest, QueryVotesResponse, TextProposal, WeightedVoteOption, Deposit, Proposal, DepositParams, MsgSubmitProposal, MsgDepositResponse, QueryTallyResultRequest, GenesisState, TallyResult, MsgSubmitProposalResponse, MsgVoteWeighted, QueryParamsResponse, QueryDepositsRequest, QueryTallyResultResponse, QueryDepositsResponse, QueryVoteRequest, MsgVoteResponse, MsgDeposit, QueryVoteResponse, QueryParamsRequest, TallyParams, MsgVote, QueryProposalsRequest, QueryDepositResponse, VotingParams, MsgVoteWeightedResponse, QueryProposalRequest, QueryProposalResponse, QueryProposalsResponse, QueryDepositRequest };
