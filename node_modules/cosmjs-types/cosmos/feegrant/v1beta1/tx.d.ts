...
export declare const MsgGrantAllowance: {
    ...
    } & { [K_1 in Exclude<keyof I, keyof MsgGrantAllowance>]: never; }>(object: I): MsgGrantAllowance;
};
export declare const MsgGrantAllowanceResponse: {
    ...
    fromPartial<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(_: I): MsgGrantAllowanceResponse;
};
export declare const MsgRevokeAllowance: {
    ...
    fromPartial<I extends {
        ...
        granter?: string | undefined;
        grantee?: string | undefined;
    } & { [K in Exclude<keyof I, keyof MsgRevokeAllowance>]: never; }>(object: I): MsgRevokeAllowance;
};
export declare const MsgRevokeAllowanceResponse: {
    ...
    fromPartial<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(_: I): MsgRevokeAllowanceResponse;
};
