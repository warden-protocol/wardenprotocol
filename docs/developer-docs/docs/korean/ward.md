...
| 카테고리 | 수량 | % | 설명 | 유통(Circulating) |
| ------- | ---- | -- | --- | ---------------- |
| 초기 에어드롭(Initial airdrop) | 47M | 4.70% | 초기 토큰 에어드롭 | 제네시스 시 30.32M 지급, 이후 6개월간 선형 베스팅 |
| 공공재(Public goods) | 53M | 5.30% | 온체인 및 소셜 활동 리더보드를 통한 지속적인 성장 활동 및 사용자 인센티브를 위한 할당 | 제네시스 시 10M 지급, 이후 30개월간 선형 베스팅 |
| 생태계 및 커뮤니티(Ecosystem & community) | 120M | 12.00% | 마케팅, 파트너십, 커뮤니티 활동 및 이벤트를 포함한 생태계 성장 지원과 퍼블릭 블록 익스플로러 및 Dune Analytics 대시보드와 같은 핵심 인프라 지원을 위한 할당 | 제네시스 시 20M 지급, 이후 30개월간 선형 베스팅 |
| 유동성(Liquidity) | 50M | 5.00% | 유동성 공급 | 베스팅 없음: 제네시스 시 100% 유통 |
| 에이전트 인센티브 및 개발자(Agent incentives & developers) | 190M | 19.00% | 그랜트 및 인센티브 프로그램을 통해 Warden 상에 에이전트 및 애플리케이션을 배포하는 프로젝트와 개발자를 장려하기 위한 할당 | 제네시스 시 20M 지급, 이후 12개월간 선형 베스팅 |
| 검증자(Validators) | 100M | 10.00% | 검증자에게 초기 위임되며, 영구적으로 잠겨 유통되지 않음 | 위임되었으나 영구 잠금 |
| 재무 및 연구개발(Treasury & R&D) | 220M | 22.00% | 탈중앙화 AI 영역에서의 첨단 기술 지속 개발을 지원하기 위한 운영 비용 및 R&D 프로그램 자금. 향후 전략적 투자 라운드가 진행될 경우 해당 자금 역시 본 할당분에서 집행됨 | 제네시스 시 120M 지급, 이후 12개월간 선형 베스팅 |
| 전략적 투자자(Strategic investors) | 20M | 2.00% | 전략적 라운드 참여자를 위해 예약된 할당 | 12개월 클리프 이후 12개월간 선형 베스팅 |
| 핵심 기여자(Core contributors) | 200M | 20.00% | 개발 팀, 자문단 및 초기 기여자를 위해 예약된 할당 | 6개월 클리프 이후 2년간 선형 베스팅 |
