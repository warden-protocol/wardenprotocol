...
The [`x/wasm` Warden module](/learn/external-modules#xwasm) allows executing **WebAssembly smart contracts** developed with [CosmWasm](https://cosmwasm.com) and **Rust**.
