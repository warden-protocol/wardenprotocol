...
type SolverRequest struct {
	SolverInput       SolverInput `protobuf:"bytes,1,opt,name=solver_input,json=solverInput,proto3" json:"solverInput"`
	ExpectedItems     int64       `protobuf:"varint,2,opt,name=ExpectedItems,proto3" json:"expectedItems"`
	FalsePositiveRate float64     `protobuf:"fixed64,3,opt,name=FalsePositiveRate,proto3" json:"falsePositiveRate"`
}
...
type SolverInput struct {
	...
	AdversaryMode bool     `protobuf:"varint,2,opt,name=adversary_mode,json=adversaryMode,proto3" json:"adversaryMode"`
}
...
type SolverResponse struct {
	SolverOutput  SolverOutput `protobuf:"bytes,1,opt,name=solver_output,json=solverOutput,proto3" json:"solverOutput"`
	SolverReceipt []byte       `protobuf:"bytes,2,opt,name=solver_receipt,json=solverReceipt,proto3" json:"solverReceipt"`
}
...
var fileDescriptor_59af2518203b8806 = []byte{
	...
	,
}
