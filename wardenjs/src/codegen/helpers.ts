...
const atob: (b64: string) => string =
  wardenjs_globalThis.atob ||
  ((b64) => wardenjs_globalThis.Buffer.from(b64, 'base64').toString('binary'));
...
const btoa: (bin: string) => string =
  wardenjs_globalThis.btoa ||
  ((bin) => wardenjs_globalThis.Buffer.from(bin, 'binary').toString('base64'));
