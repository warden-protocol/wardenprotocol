...
export interface SignRequestProtoMsg {
  typeUrl: "/warden.warden.v1beta1.SignRequest";
  value: Uint8Array;
}
...
export interface SignRequestAminoMsg {
  type: "/warden.warden.v1beta1.SignRequest";
...
export interface SignTransactionRequestProtoMsg {
  typeUrl: "/warden.warden.v1beta1.SignTransactionRequest";
  value: Uint8Array;
}
...
export interface SignTransactionRequestAminoMsg {
  type: "/warden.warden.v1beta1.SignTransactionRequest";
