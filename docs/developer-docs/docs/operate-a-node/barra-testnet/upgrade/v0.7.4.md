...
This guide provides steps for upgrading to the [Warden v0.7.4](https://github.com/warden-protocol/wardenprotocol/releases/tag/v0.7.4) release.
...
1. Download the [wardend binary v0.7.4](https://github.com/warden-protocol/wardenprotocol/releases/tag/v0.7.4) and put it to `$WARDEN_HOME/cosmovisor/upgrades/v0.7.4/bin`:
...
1. Download the [wardend binary v0.7.4](https://github.com/warden-protocol/wardenprotocol/releases/tag/v0.7.4) or build it from the source code. See the installation instructions in the [Join Barra guide](../join-barra#1-install-the-binary).
...
3. Stop the node and switch the binary to **Warden v0.7.4**. Restart the node:
