...
1. Download the [wardend binary v0.7.4](https://github.com/warden-protocol/wardenprotocol/releases/tag/v0.7.4) or build it from the source code. See the installation instructions in the [Join Mainnet guide](../join-mainnet#1-install-the-binary).
