...
3. 👉 [Swap assets](manage-assets#send-or-swap-assets): In the [chat box](use-the-chat), ask the [Warden AMA Agent](explore-ai-agents#warden-ama-agent) to swap **0.001 SOL** for **USDC**, or specify a different token and amount.
