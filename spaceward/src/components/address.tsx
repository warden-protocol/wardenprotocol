...
function getRandomColor(name: string) {
    ...
    const colorNum1 =
        asciiCode1.toString() + asciiCode1.toString() + asciiCode1.toString();
    const colorNum2 =
        asciiCode2.toString() + asciiCode2.toString() + asciiCode2.toString();

    var num = Math.round(
        (0xffffff * (parseInt(colorNum1) + parseInt(colorNum2))) / 2
    );
    var r = (num >> 16) & 255;
    var g = (num >> 8) & 255;
    var b = num & 255;
