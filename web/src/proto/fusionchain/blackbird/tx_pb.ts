...
// @generated from file fusionchain/blackbird/tx.proto (package fusionchain.blackbird, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message fusionchain.blackbird.MsgApproveAction
 */
export class MsgApproveAction extends Message<MsgApproveAction> {
  ...
  static readonly typeName = "fusionchain.blackbird.MsgApproveAction";
...
/**
 * @generated from message fusionchain.blackbird.MsgApproveActionResponse
 */
export class MsgApproveActionResponse extends Message<MsgApproveActionResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "fusionchain.blackbird.MsgApproveActionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message fusionchain.blackbird.MsgNewPolicy
 */
export class MsgNewPolicy extends Message<MsgNewPolicy> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "fusionchain.blackbird.MsgNewPolicy";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message fusionchain.blackbird.MsgNewPolicyResponse
 */
export class MsgNewPolicyResponse extends Message<MsgNewPolicyResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "fusionchain.blackbird.MsgNewPolicyResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
