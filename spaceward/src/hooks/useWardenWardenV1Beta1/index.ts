...
export default function useWardenWardenV1Beta2V1Beta1() {
  ...
  const QueryParams = ( options: any) => {
    ...
    return useQuery([key], () => {
      return  client.WardenWardenV1Beta1.query.queryParams().then( res => res.data );
    }, options);
  }
  ...
  const QuerySpaces = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      return  client.WardenWardenV1Beta1.query.querySpaces(query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
  ...
  const QuerySpacesByOwner = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.WardenWardenV1Beta1.query.querySpacesByOwner(query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QueryKeychains = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.WardenWardenV1Beta1.query.queryKeychains(query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QuerySpaceByAddress = (query: any, options: any) => {
    ...
    return useQuery([key], () => {
      const {query } = key
      return  client.WardenWardenV1Beta1.query.querySpaceByAddress(query ?? undefined).then( res => res.data );
    }, options);
  }
  ...
  const QueryKeychainByAddress = (query: any, options: any) => {
    ...
    return useQuery([key], () => {
      const {query } = key
      return  client.WardenWardenV1Beta1.query.queryKeychainByAddress(query ?? undefined).then( res => res.data );
    }, options);
  }
  ...
  const QueryKeyRequests = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.WardenWardenV1Beta1.query.queryKeyRequests(query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QueryKeyRequestById = (query: any, options: any) => {
    ...
    return useQuery([key], () => {
      const {query } = key
      return  client.WardenWardenV1Beta1.query.queryKeyRequestById(query ?? undefined).then( res => res.data );
    }, options);
  }
  ...
  const QueryKeys = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.WardenWardenV1Beta1.query.queryKeys(query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QuerySignatureRequests = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.WardenWardenV1Beta1.query.querySignatureRequests(query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QuerySignatureRequestById = (query: any, options: any) => {
    ...
    return useQuery([key], () => {
      const {query } = key
      return  client.WardenWardenV1Beta1.query.querySignatureRequestById(query ?? undefined).then( res => res.data );
    }, options);
  }
  ...
  const QuerySignTransactionRequests = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.WardenWardenV1Beta1.query.querySignTransactionRequests(query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QuerySignTransactionRequestById = (query: any, options: any) => {
    ...
    return useQuery([key], () => {
      const {query } = key
      return  client.WardenWardenV1Beta1.query.querySignTransactionRequestById(query ?? undefined).then( res => res.data );
    }, options);
  }
