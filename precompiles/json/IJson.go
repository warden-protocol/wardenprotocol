...
// ReadKeyValue is an auto generated low-level Go binding around an user-defined struct.
type ReadKeyValue struct {
	Key       string
	ValueType string
	Decimals  int64
}

// SetKeyValue is an auto generated low-level Go binding around an user-defined struct.
...
// Act is a free data retrieval call binding the contract method 0x02a3b997.
//
// Solidity: function act(bytes input, (string,string,int64)[] keyValues) view returns(int256 result)
func (_IJson *IJsonCaller) Act(opts *bind.CallOpts, input []byte, keyValues []ReadKeyValue) (*big.Int, error) {
	var out []interface{}
	err := _IJson.contract.Call(opts, &out, "act", input, keyValues)
...
//
// Solidity: function act(bytes input, (string,string,int64)[] keyValues) view returns(int256 result)
func (_IJson *IJsonSession) Act(input []byte, keyValues []ReadKeyValue) (*big.Int, error) {
	return _IJson.Contract.Act(&_IJson.CallOpts, input, keyValues)
}

// Act is a free data retrieval call binding the contract method 0x02a3b997.
//
// Solidity: function act(bytes input, (string,string,int64)[] keyValues) view returns(int256 result)
func (_IJson *IJsonCallerSession) Act(input []byte, keyValues []ReadKeyValue) (*big.Int, error) {
	return _IJson.Contract.Act(&_IJson.CallOpts, input, keyValues)
}
...
// Read is a free data retrieval call binding the contract method 0x4dbca7bc.
//
// Solidity: function read(bytes input, (string,string,int64)[] keyValues) view returns(bytes[])
func (_IJson *IJsonCaller) Read(opts *bind.CallOpts, input []byte, keyValues []ReadKeyValue) ([][]byte, error) {
	var out []interface{}
	err := _IJson.contract.Call(opts, &out, "read", input, keyValues)
...
//
// Solidity: function read(bytes input, (string,string,int64)[] keyValues) view returns(bytes[])
func (_IJson *IJsonSession) Read(input []byte, keyValues []ReadKeyValue) ([][]byte, error) {
	return _IJson.Contract.Read(&_IJson.CallOpts, input, keyValues)
}

// Read is a free data retrieval call binding the contract method 0x4dbca7bc.
//
// Solidity: function read(bytes input, (string,string,int64)[] keyValues) view returns(bytes[])
func (_IJson *IJsonCallerSession) Read(input []byte, keyValues []ReadKeyValue) ([][]byte, error) {
	return _IJson.Contract.Read(&_IJson.CallOpts, input, keyValues)
}
...
// Write is a free data retrieval call binding the contract method 0x5d425d00.
//
// Solidity: function write(bytes input, (string,string,bytes,int64)[] keyValues) view returns(bytes)
func (_IJson *IJsonCaller) Write(opts *bind.CallOpts, input []byte, keyValues []SetKeyValue) ([]byte, error) {
	var out []interface{}
	err := _IJson.contract.Call(opts, &out, "write", input, keyValues)
...
//
// Solidity: function write(bytes input, (string,string,bytes,int64)[] keyValues) view returns(bytes)
func (_IJson *IJsonSession) Write(input []byte, keyValues []SetKeyValue) ([]byte, error) {
	return _IJson.Contract.Write(&_IJson.CallOpts, input, keyValues)
}

// Write is a free data retrieval call binding the contract method 0x5d425d00.
//
// Solidity: function write(bytes input, (string,string,bytes,int64)[] keyValues) view returns(bytes)
func (_IJson *IJsonCallerSession) Write(input []byte, keyValues []SetKeyValue) ([]byte, error) {
	return _IJson.Contract.Write(&_IJson.CallOpts, input, keyValues)
}
