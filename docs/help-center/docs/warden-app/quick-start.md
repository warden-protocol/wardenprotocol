...
3. 👉 [Swap assets](manage-assets#send-or-swap-assets): In the [Chats tab](use-the-chat#start-chatting), ask the [Warden Agent](explore-ai-agents#warden-agent) to swap **0.001 SOL** for **USDC**, or specify a different token and amount.
