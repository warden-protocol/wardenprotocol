...
export const AminoConverter = {
  ...
  "/warden.warden.v1beta3.MsgMockCallback": {
    aminoType: "/warden.warden.v1beta3.MsgMockCallback",
    toAmino: MsgMockCallback.toAmino,
    fromAmino: MsgMockCallback.fromAmino
  }
};