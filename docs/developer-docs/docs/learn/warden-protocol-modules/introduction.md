...
| [`x/act`](x-act)                       | Execute Actions according to Rules      | [Get started](/build-an-app/interact-with-warden-modules/get-started), [Interact with `x/act`](/category/interact-with-xact) |
