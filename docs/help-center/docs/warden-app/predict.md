...
![Place a prediction order in Warden](../../static/img/warden-app/predict-2.png)

## Manage your portfolio

To view and manage your portfolio, open the **Predict** section and switch to the **Portfolio** tab:

![View and manage your Predictions portfolio in Warden](../../static/img/warden-app/predict-3.png)
