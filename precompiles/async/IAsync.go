...
//
// Solidity: function taskById(uint64 taskId) view returns((((uint64,address,string,bytes,((string,uint256)[],(string,uint256)[]),uint64,bytes),(uint64,bytes,uint8)[],(uint64,bytes,string))) response)
...
//
// Solidity: function tasks((bytes,uint64,uint64,bool,bool) pagination, address creator) view returns(((bytes,uint64),((uint64,address,string,bytes,((string,uint256)[],(string,uint256)[]),uint64,bytes),(uint64,bytes,uint8)[],(uint64,bytes,string))[]) response)
