...
/**
 * @generated from message fusionchain.identity.QueryKeyringByIdRequest
 */
export class QueryKeyringByIdRequest extends Message<QueryKeyringByIdRequest> {
  /**
   * @generated from field: uint64 id = 1;
   */
  id = protoInt64.zero;

  constructor(data?: PartialMessage<QueryKeyringByIdRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "fusionchain.identity.QueryKeyringByIdRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): QueryKeyringByIdRequest {
    return new QueryKeyringByIdRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): QueryKeyringByIdRequest {
    return new QueryKeyringByIdRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): QueryKeyringByIdRequest {
    return new QueryKeyringByIdRequest().fromJsonString(jsonString, options);
  }

  static equals(a: QueryKeyringByIdRequest | PlainMessage<QueryKeyringByIdRequest> | undefined, b: QueryKeyringByIdRequest | PlainMessage<QueryKeyringByIdRequest> | undefined): boolean {
    return proto3.util.equals(QueryKeyringByIdRequest, a, b);
  }
}

/**
 * @generated from message fusionchain.identity.QueryKeyringByIdResponse
 */
export class QueryKeyringByIdResponse extends Message<QueryKeyringByIdResponse> {
  /**
   * @generated from field: fusionchain.identity.Keyring keyring = 1;
   */
  keyring?: Keyring;

  constructor(data?: PartialMessage<QueryKeyringByIdResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "fusionchain.identity.QueryKeyringByIdResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "keyring", kind: "message", T: Keyring },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): QueryKeyringByIdResponse {
    return new QueryKeyringByIdResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): QueryKeyringByIdResponse {
    return new QueryKeyringByIdResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): QueryKeyringByIdResponse {
    return new QueryKeyringByIdResponse().fromJsonString(jsonString, options);
  }

  static equals(a: QueryKeyringByIdResponse | PlainMessage<QueryKeyringByIdResponse> | undefined, b: QueryKeyringByIdResponse | PlainMessage<QueryKeyringByIdResponse> | undefined): boolean {
    return proto3.util.equals(QueryKeyringByIdResponse, a, b);
  }
}
