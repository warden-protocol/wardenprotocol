...
// @generated from file wardenprotocol/intent/action.proto (package wardenprotocol.intent, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum wardenprotocol.intent.ActionStatus
 */
...
proto3.util.setEnumType(ActionStatus, "wardenprotocol.intent.ActionStatus", [
 ...
 *
 * @generated from message wardenprotocol.intent.Action
 */
export class Action extends Message<Action> {
   ...
   * apply.
   *
   * @generated from field: uint64 intent_id = 4;
   */
  intentId = protoInt64.zero;
  ...
  static readonly typeName = "wardenprotocol.intent.Action";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "intent_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
