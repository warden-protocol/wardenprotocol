...
/**
 * @generated from message fusionchain.identity.QueryKeyringByAddressRequest
 */
export class QueryKeyringByAddressRequest extends Message<QueryKeyringByAddressRequest> {
  /**
   * @generated from field: string address = 1;
   */
  address = "";

  constructor(data?: PartialMessage<QueryKeyringByAddressRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "fusionchain.identity.QueryKeyringByAddressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): QueryKeyringByAddressRequest {
    return new QueryKeyringByAddressRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): QueryKeyringByAddressRequest {
    return new QueryKeyringByAddressRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): QueryKeyringByAddressRequest {
    return new QueryKeyringByAddressRequest().fromJsonString(jsonString, options);
  }

  static equals(a: QueryKeyringByAddressRequest | PlainMessage<QueryKeyringByAddressRequest> | undefined, b: QueryKeyringByAddressRequest | PlainMessage<QueryKeyringByAddressRequest> | undefined): boolean {
    return proto3.util.equals(QueryKeyringByAddressRequest, a, b);
  }
}

/**
 * @generated from message fusionchain.identity.QueryKeyringByAddressResponse
 */
export class QueryKeyringByAddressResponse extends Message<QueryKeyringByAddressResponse> {
  /**
   * @generated from field: fusionchain.identity.Keyring keyring = 1;
   */
  keyring?: Keyring;

  constructor(data?: PartialMessage<QueryKeyringByAddressResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "fusionchain.identity.QueryKeyringByAddressResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "keyring", kind: "message", T: Keyring },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): QueryKeyringByAddressResponse {
    return new QueryKeyringByAddressResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): QueryKeyringByAddressResponse {
    return new QueryKeyringByAddressResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): QueryKeyringByAddressResponse {
    return new QueryKeyringByAddressResponse().fromJsonString(jsonString, options);
  }

  static equals(a: QueryKeyringByAddressResponse | PlainMessage<QueryKeyringByAddressResponse> | undefined, b: QueryKeyringByAddressResponse | PlainMessage<QueryKeyringByAddressResponse> | undefined): boolean {
    return proto3.util.equals(QueryKeyringByAddressResponse, a, b);
  }
}
