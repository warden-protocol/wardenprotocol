...
1. Download the [wardend binary v0.7.6](https://github.com/warden-protocol/wardenprotocol/releases/tag/v0.7.6) or build it from the source code. See the installation instructions in the [Join Barra guide](../join-barra#1-install-the-binary).

2. Run Warden v0.7.3 until the upgrade height. The node will panic:

   ```shell
   ERR UPGRADE "v0.7.4" NEEDED at height: 3265800: upgrade to v0.7.4 and applying upgrade "v0.7.4" at height: 3265800
   ```
