...
Prior to the update, you should also run the **Skip:Connect** binary on the same machine as `wardend`. Make sure you enable it from the [configuration](../../operate-skip-connect#3-configure-wardend).

Follow this guide: [Operate Skip:Connect](../../operate-skip-connect).
