...
import (
	...
	evmrest "github.com/qredo/fusionchain/x/evm/client/rest"
	...
	wasmclient "github.com/qredo/fusionchain/x/wasm/client"
...
var (
	...
	// https://github.com/qredo/fusionchain/blob/02a54d33ff2c064f3539ae12d75d027d9c665f05/x/wasm/internal/types/proposal.go#L28-L34
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		gov.NewAppModuleBasic(
			append(
				wasmclient.ProposalHandlers, paramsclient.ProposalHandler, distrclient.ProposalHandler,
