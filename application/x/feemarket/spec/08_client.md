...
```
fusiond query feemarket base-fee [height] [flags]
```

Example:

```
fusiond query feemarket base-fee 5...
```
...
```
fusiond query feemarket block-gas [height] [flags]
```

Example:

```
fusiond query feemarket block-gas 5...
```
...
```
fusiond query params subspace [subspace] [key] [flags]
```

Example:

```
fusiond query params subspace feemarket ElasticityMultiplier ...
```
