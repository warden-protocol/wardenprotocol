...
export declare function createTxMsgRegisterFeeSplit(chain: Chain, sender: Sender, fee: Fee, memo: string, params: MessageMsgRegisterFeeSplit): {
    signDirect: {
...
//# sourceMappingURL=msgRegisterFeeSplit.d.ts.map