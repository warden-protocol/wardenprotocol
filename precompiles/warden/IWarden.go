...
// NewSignRequest is a paid mutator transaction binding the contract method 0x969dc46e.
//
// Solidity: function newSignRequest(uint64 keyId, bytes input, bytes[] analyzers, bytes encryptionKey, (string,uint256)[] maxKeychainFees, uint64 nonce, uint64 actionTimeoutHeight, string expectedApproveExpression, string expectedRejectExpression) returns(bool success)
func (_IWarden *IWardenTransactor) NewSignRequest(opts *bind.TransactOpts, keyId uint64, input []byte, analyzers [][]byte, encryptionKey []byte, maxKeychainFees []TypesCoin, nonce uint64, actionTimeoutHeight uint64, expectedApproveExpression string, expectedRejectExpression string) (*types.Transaction, error) {
...
//
// Solidity: function newSignRequest(uint64 keyId, bytes input, bytes[] analyzers, bytes encryptionKey, (string,uint256)[] maxKeychainFees, uint64 nonce, uint64 actionTimeoutHeight, string expectedApproveExpression, string expectedRejectExpression) returns(bool success)
func (_IWarden *IWardenSession) NewSignRequest(keyId uint64, input []byte, analyzers [][]byte, encryptionKey []byte, maxKeychainFees []TypesCoin, nonce uint64, actionTimeoutHeight uint64, expectedApproveExpression string, expectedRejectExpression string) (*types.Transaction, error) {
...
//
// Solidity: function newSignRequest(uint64 keyId, bytes input, bytes[] analyzers, bytes encryptionKey, (string,uint256)[] maxKeychainFees, uint64 nonce, uint64 actionTimeoutHeight, string expectedApproveExpression, string expectedRejectExpression) returns(bool success)
func (_IWarden *IWardenTransactorSession) NewSignRequest(keyId uint64, input []byte, analyzers [][]byte, encryptionKey []byte, maxKeychainFees []TypesCoin, nonce uint64, actionTimeoutHeight uint64, expectedApproveExpression string, expectedRejectExpression string) (*types.Transaction, error) {
	return _IWarden.Contract.NewSignRequest(&_IWarden.TransactOpts, keyId, input, analyzers, encryptionKey, maxKeychainFees, nonce, actionTimeoutHeight, expectedApproveExpression, expectedRejectExpression)
}
