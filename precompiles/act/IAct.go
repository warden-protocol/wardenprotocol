...
//
// Solidity: function actionById(uint64 actionId) view returns(((uint64,int256,string,(string,bytes),(string,bytes),address,uint64,(uint64,uint64),(uint64,uint64),string,string,address[],(string,(uint64,uint64),int32,string)[])) response)
...
//
// Solidity: function actions((bytes,uint64,uint64,bool,bool) pagination) view returns(((bytes,uint64),(uint64,int256,string,(string,bytes),(string,bytes),address,uint64,(uint64,uint64),(uint64,uint64),string,string,address[],(string,(uint64,uint64),int32,string)[])[]) response)
...
//
// Solidity: function actionsByAddress((bytes,uint64,uint64,bool,bool) pagination, address addr, int32 status) view returns(((bytes,uint64),(uint64,int256,string,(string,bytes),(string,bytes),address,uint64,(uint64,uint64),(uint64,uint64),string,string,address[],(string,(uint64,uint64),int32,string)[])[]) response)
...
//
// Solidity: function templates((bytes,uint64,uint64,bool,bool) pagination) view returns(((bytes,uint64),(uint64,address,string,string)[]) response)
