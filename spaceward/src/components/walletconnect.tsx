...
function useWeb3Wallet(relayUrl: string) {
  ...
  const updateState = useCallback(() => {
    ...
    setActiveSessions([
      ...(Object.values(w.getActiveSessions()) as any as SessionTypes.Struct[]),
    ]);
  }, [w]);
...
export function WalletConnect() {
  ...
  return (
    <Popover.Root modal={true} open={open} onOpenChange={() => setOpen(!open)}>
      ...
      <Popover.Portal>
        <Popover.Content
          side="left"
          className="bg-transparent z-[5000] w-screen rounded-none h-screen overflow-scroll no-scrollbar"
        >
          <div
            className="inset-0 bg-background/70 absolute"
            onClick={() => setOpen(false)}
          ></div>
          <div className="p-10 pt-0 flex flex-col space-y-4 w-[600px] bg-background fixed h-screen right-0">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="text-center pt-0">
                ...
                <p className="text-sm">
                  Paste the pairing code below to connect your keys via
                  WalletConnect
                </p>
              </div>
              <div>
                      ...
                      <div>
                        <div className="flex flex-row gap-2">
                          ...
                          <div className="flex flex-col">
                            <div>{s.proposer.metadata.name}</div>
                            <div>{s.proposer.metadata.description}</div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-row gap-2 justify-between">
                          <div className="flex flex-row gap-4 items-center">
                            <img
                              ...
                              src={
                                activeSessions
                                  .find((s) => s.topic === req.topic)
                                  ?.peer.metadata.icons[0].startsWith("http")
                                  ? activeSessions.find(
                                      (s) => s.topic === req.topic
                                ...
                                try {
                                  ...
                                  switch (req.params.request.method) {
                                    case "personal_sign": {
                                      ...
                                      // prepare message
                                      const msg = fromHex(
                                        req.params.request.params[0].slice(2)
                                      );
                                    ...
                                    case "eth_sendTransaction": {
                                      ...
                                      const tx =
                                        await buildEthTransaction(txParam);
                                      const signature =
                        ...
                        <div className="flex flex-row gap-2 justify-between">
                          <div className="flex flex-row gap-4 items-center">
                            ...
                            <span className="text-sm flex flex-col">
                              <span>{s.peer.metadata.name}</span>
                  ...
                  <AccordionItem value="item-1" className="border-b-0 p-2">
                    ...
                    <AccordionContent className="px-4">
                      <ol className="list-decimal space-y-1">
                        ...
                        <li>
                          Copy the pairing code, paste it into the input field
                          above
                        </li>
