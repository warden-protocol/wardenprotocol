...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    slinky: {
      marketmap: {
        v1: (await import("./marketmap/v1/query.rpc.Query.js")).createRpcQueryExtension(client)
      },
      oracle: {
        v1: (await import("./oracle/v1/query.rpc.Query.js")).createRpcQueryExtension(client)
      }
    }
  };
};