...
// @generated from file wardenprotocol/treasury/key.proto (package wardenprotocol.treasury, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum wardenprotocol.treasury.KeyRequestStatus
 */
...
proto3.util.setEnumType(KeyRequestStatus, "wardenprotocol.treasury.KeyRequestStatus", [
 ...
 *
 * @generated from enum wardenprotocol.treasury.KeyType
 */
export enum KeyType {
  /**
...
proto3.util.setEnumType(KeyType, "wardenprotocol.treasury.KeyType", [
...
/**
 * @generated from message wardenprotocol.treasury.KeyRequest
 */
export class KeyRequest extends Message<KeyRequest> {
  ...
  /**
   * @generated from field: string space_addr = 3;
   */
  spaceAddr = "";

  /**
   * @generated from field: string keychain_addr = 4;
   */
  keychainAddr = "";

  /**
   * @generated from field: wardenprotocol.treasury.KeyType key_type = 5;
   */
  keyType = KeyType.UNSPECIFIED;

  /**
   * @generated from field: wardenprotocol.treasury.KeyRequestStatus status = 6;
   */
  ...
  static readonly typeName = "wardenprotocol.treasury.KeyRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "space_addr", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "keychain_addr", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message wardenprotocol.treasury.Key
 */
export class Key extends Message<Key> {
  ...
  /**
   * @generated from field: wardenprotocol.treasury.KeyType type = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wardenprotocol.treasury.Key";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
