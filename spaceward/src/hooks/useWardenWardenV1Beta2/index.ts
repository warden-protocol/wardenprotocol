...
export default function useWardenWardenV1Beta2() {
  ...
  return {QueryParams,QuerySpaces,QuerySpacesByOwner,QueryKeychains,QuerySpaceById,QueryKeychainById,QueryKeyRequests,QueryKeyRequestById,QueryAllKeys,QueryKeysBySpaceId,QueryKeyById,QuerySignatureRequests,QuerySignatureRequestById,
  }
}
