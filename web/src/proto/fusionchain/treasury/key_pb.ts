...
export class KeyRequest extends Message<KeyRequest> {
  ...
  /**
   * @generated from field: uint64 keyring_id = 4;
   */
   ...
   * rejection.
   *
   * @generated from oneof fusionchain.treasury.KeyRequest.result
   */
  result: {
    /**
     * @generated from field: uint64 success_key_id = 7;
     */
    value: bigint;
    case: "successKeyId";
  } | {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "keyring_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    ...
    { no: 7, name: "success_key_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */, oneof: "result" },
    { no: 8, name: "reject_reason", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "result" },
  ]);
