...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"fusionchain", "blackbird", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Verify_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"fusionchain", "blackbird", "verify", "policy", "payload"}, "", runtime.AssumeColonVerbOpt(true)))
)
