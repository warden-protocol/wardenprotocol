...
- Discoverability outside of Warden through [ERC-8004 Identity Registry](https://eips.ethereum.org/EIPS/eip-8004)
...
- Built-in [frontend](basics#frontend) that automatically loads the A2A Agent Card and x402 wallets
- The AI-powered [build mode](basics#build-mode) allowing you to implement custom Agent logic with an AI assistant

To learn more, see [Agent capabilities](agent-capabilities).
