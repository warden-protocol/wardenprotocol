...
type KeyRequest struct {
	...
	Status      KeyRequestStatus `protobuf:"varint,5,opt,name=status,proto3,enum=fusionchain.treasury.KeyRequestStatus" json:"status,omitempty"`
...
type KeyRequest_SuccessKeyId struct {
	SuccessKeyId uint64 `protobuf:"varint,6,opt,name=success_key_id,json=successKeyId,proto3,oneof" json:"success_key_id,omitempty"`
}
...
type Key struct {
	...
	Type        KeyType `protobuf:"varint,3,opt,name=type,proto3,enum=fusionchain.treasury.KeyType" json:"type,omitempty"`
...
var fileDescriptor_c4c8664de1491f4e = []byte{
	...
	,
}
