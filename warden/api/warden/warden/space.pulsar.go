...
func init() {
	...
	md_Space = File_warden_warden_space_proto.Messages().ByName("Space")
...
func (x *Space) slowProtoReflect() protoreflect.Message {
	mi := &file_warden_warden_space_proto_msgTypes[0]
...
func (x *fastReflection_Space) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "warden.warden.Space.address":
		return x.Address != ""
	case "warden.warden.Space.creator":
		return x.Creator != ""
	case "warden.warden.Space.owners":
		return len(x.Owners) != 0
	case "warden.warden.Space.admin_intent_id":
		return x.AdminIntentId != uint64(0)
	case "warden.warden.Space.sign_intent_id":
		return x.SignIntentId != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: warden.warden.Space"))
		}
		panic(fmt.Errorf("message warden.warden.Space does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Space) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message warden.warden.Space does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Space) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "warden.warden.Space.address":
		panic(fmt.Errorf("field address of message warden.warden.Space is not mutable"))
	case "warden.warden.Space.creator":
		panic(fmt.Errorf("field creator of message warden.warden.Space is not mutable"))
	case "warden.warden.Space.admin_intent_id":
		panic(fmt.Errorf("field admin_intent_id of message warden.warden.Space is not mutable"))
	case "warden.warden.Space.sign_intent_id":
		panic(fmt.Errorf("field sign_intent_id of message warden.warden.Space is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: warden.warden.Space"))
		}
...
func (x *fastReflection_Space) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in warden.warden.Space", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: warden/warden/space.proto
...
func (*Space) Descriptor() ([]byte, []int) {
	return file_warden_warden_space_proto_rawDescGZIP(), []int{0}
}
...
var File_warden_warden_space_proto protoreflect.FileDescriptor

var file_warden_warden_space_proto_rawDesc = []byte{
	0x0a, 0x19, 0x77, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x2f, 0x77, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x2f,
	0x73, 0x70, 0x61, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x77, 0x61, 0x72,
	0x64, 0x65, 0x6e, 0x2e, 0x77, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x22, 0xa1, 0x01, 0x0a, 0x05, 0x53,
	...
	0x52, 0x0c, 0x73, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x42, 0x94,
	0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x77, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x2e, 0x77, 0x61,
	0x72, 0x64, 0x65, 0x6e, 0x42, 0x0a, 0x53, 0x70, 0x61, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x65, 0x6e, 0xa2, 0x02, 0x03, 0x57, 0x57, 0x58, 0xaa, 0x02, 0x0d, 0x57, 0x61, 0x72, 0x64, 0x65,
	0x6e, 0x2e, 0x57, 0x61, 0x72, 0x64, 0x65, 0x6e, 0xca, 0x02, 0x0d, 0x57, 0x61, 0x72, 0x64, 0x65,
	0x6e, 0x5c, 0x57, 0x61, 0x72, 0x64, 0x65, 0x6e, 0xe2, 0x02, 0x19, 0x57, 0x61, 0x72, 0x64, 0x65,
	0x6e, 0x5c, 0x57, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0e, 0x57, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x3a, 0x3a, 0x57,
	0x61, 0x72, 0x64, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_warden_warden_space_proto_rawDescOnce sync.Once
	file_warden_warden_space_proto_rawDescData = file_warden_warden_space_proto_rawDesc
)

func file_warden_warden_space_proto_rawDescGZIP() []byte {
	file_warden_warden_space_proto_rawDescOnce.Do(func() {
		file_warden_warden_space_proto_rawDescData = protoimpl.X.CompressGZIP(file_warden_warden_space_proto_rawDescData)
	})
	return file_warden_warden_space_proto_rawDescData
}

var file_warden_warden_space_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_warden_warden_space_proto_goTypes = []interface{}{
	(*Space)(nil), // 0: warden.warden.Space
}
var file_warden_warden_space_proto_depIdxs = []int32{
...
func init() { file_warden_warden_space_proto_init() }
func file_warden_warden_space_proto_init() {
	if File_warden_warden_space_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_warden_warden_space_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Space); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_warden_warden_space_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_warden_warden_space_proto_goTypes,
		DependencyIndexes: file_warden_warden_space_proto_depIdxs,
		MessageInfos:      file_warden_warden_space_proto_msgTypes,
	}.Build()
	File_warden_warden_space_proto = out.File
	file_warden_warden_space_proto_rawDesc = nil
	file_warden_warden_space_proto_goTypes = nil
	file_warden_warden_space_proto_depIdxs = nil
}
