...
Prior to the update, you should also run the **Skip:Connect** binary on the same machine as `wardend`. Make sure you enable it from the [configuration](https://docs.skip.build/connect/validators/configuration).
