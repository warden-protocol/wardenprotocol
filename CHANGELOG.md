...
* (types) [tharsis#503](https://github.com/cosmos/ethermint/pull/503) The `types.DenomDefault` constant for `"qrdo"` has been renamed to `types.AttoPhoton`.
...
* (types) [tharsis#434](https://github.com/cosmos/ethermint/issues/434) Update default denomination to Atto Photon (`qrdo`).
...
* (types) [tharsis#507](https://github.com/cosmos/ethermint/pull/507) Fix hardcoded `qrdo` on `EthAccount` balance getter and setter.
