...
import type { BlockIDFlag, ValidatorSet } from "./validator_pb.js";
 ...
 */
export declare class ExtendedCommit extends Message<ExtendedCommit> {
  /**
   * @generated from field: int64 height = 1;
   */
  height: bigint;
 ...
 */
export declare class ExtendedCommitSig extends Message<ExtendedCommitSig> {
  /**
   * @generated from field: tendermint.types.BlockIDFlag block_id_flag = 1;
   */
  blockIdFlag: BlockIDFlag;
