...
const msgTypes: Array<[string, GeneratedType]>  = [
    ["/warden.warden.v1beta1.MsgAddKeychainPartyResponse", MsgAddKeychainPartyResponse],
    ["/warden.warden.v1beta1.QueryParamsRequest", QueryParamsRequest],
    ["/warden.warden.v1beta1.MsgNewSignTransactionRequestResponse", MsgNewSignTransactionRequestResponse],
    ["/warden.warden.v1beta1.QuerySpacesByOwnerRequest", QuerySpacesByOwnerRequest],
    ["/warden.warden.v1beta1.QueryKeyRequestsRequest", QueryKeyRequestsRequest],
    ["/warden.warden.v1beta1.QueryKeysResponse", QueryKeysResponse],
    ["/warden.warden.v1beta1.MsgFulfilSignatureRequest", MsgFulfilSignatureRequest],
    ["/warden.warden.v1beta1.KeychainFees", KeychainFees],
    ["/warden.warden.v1beta1.QuerySignTransactionRequestByIdRequest", QuerySignTransactionRequestByIdRequest],
    ["/warden.warden.v1beta1.QuerySpacesResponse", QuerySpacesResponse],
    ["/warden.warden.v1beta1.QueryKeychainByAddressRequest", QueryKeychainByAddressRequest],
    ["/warden.warden.v1beta1.QueryKeyRequestByIdResponse", QueryKeyRequestByIdResponse],
    ["/warden.warden.v1beta1.SignTransactionRequestResponse", SignTransactionRequestResponse],
    ["/warden.warden.v1beta1.MsgRemoveSpaceOwner", MsgRemoveSpaceOwner],
    ["/warden.warden.v1beta1.MsgNewKeyRequest", MsgNewKeyRequest],
    ["/warden.warden.v1beta1.MsgNewSignTransactionRequest", MsgNewSignTransactionRequest],
    ["/warden.warden.v1beta1.Space", Space],
    ["/warden.warden.v1beta1.QueryKeychainsResponse", QueryKeychainsResponse],
    ["/warden.warden.v1beta1.KeyResponse", KeyResponse],
    ["/warden.warden.v1beta1.QuerySignatureRequestByIdResponse", QuerySignatureRequestByIdResponse],
    ["/warden.warden.v1beta1.MsgNewKeychain", MsgNewKeychain],
    ["/warden.warden.v1beta1.MsgUpdateKeychainResponse", MsgUpdateKeychainResponse],
    ["/warden.warden.v1beta1.MsgNewKeyRequestResponse", MsgNewKeyRequestResponse],
    ["/warden.warden.v1beta1.GenesisState", GenesisState],
    ["/warden.warden.v1beta1.Keychain", Keychain],
    ["/warden.warden.v1beta1.MsgFulfilSignatureRequestResponse", MsgFulfilSignatureRequestResponse],
    ["/warden.warden.v1beta1.QueryKeychainsRequest", QueryKeychainsRequest],
    ["/warden.warden.v1beta1.QuerySpaceByAddressResponse", QuerySpaceByAddressResponse],
    ["/warden.warden.v1beta1.QueryKeysRequest", QueryKeysRequest],
    ["/warden.warden.v1beta1.MsgUpdateKeyRequest", MsgUpdateKeyRequest],
    ["/warden.warden.v1beta1.QueryParamsResponse", QueryParamsResponse],
    ["/warden.warden.v1beta1.QueryKeyRequestsResponse", QueryKeyRequestsResponse],
    ["/warden.warden.v1beta1.Key", Key],
    ["/warden.warden.v1beta1.MsgUpdateSpace", MsgUpdateSpace],
    ["/warden.warden.v1beta1.MsgNewSignatureRequestResponse", MsgNewSignatureRequestResponse],
    ["/warden.warden.v1beta1.QuerySignTransactionRequestsRequest", QuerySignTransactionRequestsRequest],
    ["/warden.warden.v1beta1.QuerySignTransactionRequestsResponse", QuerySignTransactionRequestsResponse],
    ["/warden.warden.v1beta1.MsgAddSpaceOwner", MsgAddSpaceOwner],
    ["/warden.warden.v1beta1.MsgNewKey", MsgNewKey],
    ["/warden.warden.v1beta1.MsgUpdateKeyRequestResponse", MsgUpdateKeyRequestResponse],
    ["/warden.warden.v1beta1.QuerySignatureRequestsResponse", QuerySignatureRequestsResponse],
    ["/warden.warden.v1beta1.MetadataEthereum", MetadataEthereum],
    ["/warden.warden.v1beta1.KeyRequest", KeyRequest],
    ["/warden.warden.v1beta1.MsgUpdateParams", MsgUpdateParams],
    ["/warden.warden.v1beta1.MsgNewSpace", MsgNewSpace],
    ["/warden.warden.v1beta1.MsgNewSpaceResponse", MsgNewSpaceResponse],
    ["/warden.warden.v1beta1.MsgAddKeychainParty", MsgAddKeychainParty],
    ["/warden.warden.v1beta1.MsgUpdateSpaceResponse", MsgUpdateSpaceResponse],
    ["/warden.warden.v1beta1.MsgSignedData", MsgSignedData],
    ["/warden.warden.v1beta1.QuerySignatureRequestsRequest", QuerySignatureRequestsRequest],
    ["/warden.warden.v1beta1.MsgUpdateParamsResponse", MsgUpdateParamsResponse],
    ["/warden.warden.v1beta1.MsgRemoveSpaceOwnerResponse", MsgRemoveSpaceOwnerResponse],
    ["/warden.warden.v1beta1.SignTransactionRequest", SignTransactionRequest],
    ["/warden.warden.v1beta1.QuerySignTransactionRequestByIdResponse", QuerySignTransactionRequestByIdResponse],
    ["/warden.warden.v1beta1.Params", Params],
    ["/warden.warden.v1beta1.MsgAddSpaceOwnerResponse", MsgAddSpaceOwnerResponse],
    ["/warden.warden.v1beta1.MsgNewKeychainResponse", MsgNewKeychainResponse],
    ["/warden.warden.v1beta1.MsgNewSignatureRequest", MsgNewSignatureRequest],
    ["/warden.warden.v1beta1.QuerySpacesRequest", QuerySpacesRequest],
    ["/warden.warden.v1beta1.QuerySpaceByAddressRequest", QuerySpaceByAddressRequest],
    ["/warden.warden.v1beta1.QueryKeychainByAddressResponse", QueryKeychainByAddressResponse],
    ["/warden.warden.v1beta1.MsgUpdateKeychain", MsgUpdateKeychain],
    ["/warden.warden.v1beta1.QueryKeyRequestByIdRequest", QueryKeyRequestByIdRequest],
    ["/warden.warden.v1beta1.WalletKeyResponse", WalletKeyResponse],
    ["/warden.warden.v1beta1.QuerySignatureRequestByIdRequest", QuerySignatureRequestByIdRequest],
    ["/warden.warden.v1beta1.SignRequest", SignRequest],
