...
func (k Keeper) newSignRequestTemplate(ctx context.Context, msg *v1beta3.MsgNewSignRequest) (context.Context, acttypes.Template, acttypes.Template, error) {
	...
	approveTemplate, err := k.getApproveKeyTemplate(ctx, space, key)
	if err != nil {
		return nil, acttypes.Template{}, acttypes.Template{}, err
	}

	rejectTemplate, err := k.getRejectKeyTemplate(ctx, space, key)
	if err != nil {
		return nil, acttypes.Template{}, acttypes.Template{}, err
	}
...
func (k Keeper) getApproveKeyTemplate(ctx context.Context, space v1beta3.Space, key v1beta3.Key) (acttypes.Template, error) {
...
func (k Keeper) getRejectKeyTemplate(ctx context.Context, space v1beta3.Space, key v1beta3.Key) (acttypes.Template, error) {
