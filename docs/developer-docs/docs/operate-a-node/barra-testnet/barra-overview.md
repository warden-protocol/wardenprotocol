...
| [v0.7.6](https://github.com/warden-protocol/wardenprotocol/releases/tag/v0.7.6)         | 3265800      | January 12, 2026   | [Upgrade to v0.7.6](upgrade/v0.7.6)   |
| [v1.0.1](https://github.com/warden-protocol/wardenprotocol/releases/tag/v1.0.1)         | 4619000      | March 23, 2026     | [Upgrade to v1.0.1](upgrade/v1.0.1)   |

You can also see the [binary changelog](https://github.com/warden-protocol/wardenprotocol/blob/main/CHANGELOG.md).

## Binary

The latest binary version compatible with Barra is [wardend v1.0.1](https://github.com/warden-protocol/wardenprotocol/releases/tag/v1.0.1).
