...
export declare function createTxMsgUpdateFeeSplit(chain: Chain, sender: Sender, fee: Fee, memo: string, params: MessageMsgUpdateFeeSplit): {
    signDirect: {
...
//# sourceMappingURL=msgUpdateFeeSplit.d.ts.map