...
//
// Solidity: function signRequestById(uint64 id) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],int32) signRequest)
...
// SignRequests is a free data retrieval call binding the contract method 0x59336c08.
//
// Solidity: function signRequests((bytes,uint64,uint64,bool,bool) pageRequest, uint64 keychainId, int32 status, int32 broadcastType) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],int32)[] signRequests, (bytes,uint64) pageResponse)
func (_IWarden *IWardenCaller) SignRequests(opts *bind.CallOpts, pageRequest TypesPageRequest, keychainId uint64, status int32, broadcastType int32) (struct {
	SignRequests []SignRequest
	PageResponse TypesPageResponse
}, error) {
	var out []interface{}
	err := _IWarden.contract.Call(opts, &out, "signRequests", pageRequest, keychainId, status, broadcastType)
...
//
// Solidity: function signRequests((bytes,uint64,uint64,bool,bool) pageRequest, uint64 keychainId, int32 status, int32 broadcastType) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],int32)[] signRequests, (bytes,uint64) pageResponse)
func (_IWarden *IWardenSession) SignRequests(pageRequest TypesPageRequest, keychainId uint64, status int32, broadcastType int32) (struct {
	SignRequests []SignRequest
	PageResponse TypesPageResponse
}, error) {
	return _IWarden.Contract.SignRequests(&_IWarden.CallOpts, pageRequest, keychainId, status, broadcastType)
}

// SignRequests is a free data retrieval call binding the contract method 0x59336c08.
//
// Solidity: function signRequests((bytes,uint64,uint64,bool,bool) pageRequest, uint64 keychainId, int32 status, int32 broadcastType) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],int32)[] signRequests, (bytes,uint64) pageResponse)
func (_IWarden *IWardenCallerSession) SignRequests(pageRequest TypesPageRequest, keychainId uint64, status int32, broadcastType int32) (struct {
	SignRequests []SignRequest
	PageResponse TypesPageResponse
}, error) {
	return _IWarden.Contract.SignRequests(&_IWarden.CallOpts, pageRequest, keychainId, status, broadcastType)
...
// NewSignRequest is a paid mutator transaction binding the contract method 0xf061e9ae.
//
// Solidity: function newSignRequest(uint64 keyId, bytes input, bytes[] analyzers, bytes encryptionKey, (string,uint256)[] maxKeychainFees, uint64 nonce, uint64 actionTimeoutHeight, string expectedApproveExpression, string expectedRejectExpression, int32 broadcastType) returns(bool success)
func (_IWarden *IWardenTransactor) NewSignRequest(opts *bind.TransactOpts, keyId uint64, input []byte, analyzers [][]byte, encryptionKey []byte, maxKeychainFees []TypesCoin, nonce uint64, actionTimeoutHeight uint64, expectedApproveExpression string, expectedRejectExpression string, broadcastType int32) (*types.Transaction, error) {
...
//
// Solidity: function newSignRequest(uint64 keyId, bytes input, bytes[] analyzers, bytes encryptionKey, (string,uint256)[] maxKeychainFees, uint64 nonce, uint64 actionTimeoutHeight, string expectedApproveExpression, string expectedRejectExpression, int32 broadcastType) returns(bool success)
func (_IWarden *IWardenSession) NewSignRequest(keyId uint64, input []byte, analyzers [][]byte, encryptionKey []byte, maxKeychainFees []TypesCoin, nonce uint64, actionTimeoutHeight uint64, expectedApproveExpression string, expectedRejectExpression string, broadcastType int32) (*types.Transaction, error) {
...
//
// Solidity: function newSignRequest(uint64 keyId, bytes input, bytes[] analyzers, bytes encryptionKey, (string,uint256)[] maxKeychainFees, uint64 nonce, uint64 actionTimeoutHeight, string expectedApproveExpression, string expectedRejectExpression, int32 broadcastType) returns(bool success)
func (_IWarden *IWardenTransactorSession) NewSignRequest(keyId uint64, input []byte, analyzers [][]byte, encryptionKey []byte, maxKeychainFees []TypesCoin, nonce uint64, actionTimeoutHeight uint64, expectedApproveExpression string, expectedRejectExpression string, broadcastType int32) (*types.Transaction, error) {
	return _IWarden.Contract.NewSignRequest(&_IWarden.TransactOpts, keyId, input, analyzers, encryptionKey, maxKeychainFees, nonce, actionTimeoutHeight, expectedApproveExpression, expectedRejectExpression, broadcastType)
}
...
// FilterNewSignRequest is a free log retrieval operation binding the contract event 0xb548cb7f43e0d258c216a7c99ec5225250463eedd057d37e8f1762f06718663b.
//
// Solidity: event NewSignRequest(uint64 indexed id, uint64 keyId, address creator, int32 broadcastType)
...
// WatchNewSignRequest is a free log subscription operation binding the contract event 0xb548cb7f43e0d258c216a7c99ec5225250463eedd057d37e8f1762f06718663b.
//
// Solidity: event NewSignRequest(uint64 indexed id, uint64 keyId, address creator, int32 broadcastType)
...
// ParseNewSignRequest is a log parse operation binding the contract event 0xb548cb7f43e0d258c216a7c99ec5225250463eedd057d37e8f1762f06718663b.
//
// Solidity: event NewSignRequest(uint64 indexed id, uint64 keyId, address creator, int32 broadcastType)
...
func (_IWarden *IWardenFilterer) FilterUpdateSpace(opts *bind.FilterOpts, space_id []uint64) (*IWardenUpdateSpaceIterator, error) {
	...
	var space_idRule []interface{}
	for _, space_idItem := range space_id {
		space_idRule = append(space_idRule, space_idItem)
	}

	logs, sub, err := _IWarden.contract.FilterLogs(opts, "UpdateSpace", space_idRule)
	if err != nil {
		return nil, err
	}
...
func (_IWarden *IWardenFilterer) WatchUpdateSpace(opts *bind.WatchOpts, sink chan<- *IWardenUpdateSpace, space_id []uint64) (event.Subscription, error) {
	...
	logs, sub, err := _IWarden.contract.WatchLogs(opts, "UpdateSpace", space_idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
