...
var _ protoreflect.List = (*_Action_15_list)(nil)

type _Action_15_list struct {
	list *[]*ActionVote
}

func (x *_Action_15_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Action_15_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_Action_15_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ActionVote)
	(*x.list)[i] = concreteValue
}

func (x *_Action_15_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ActionVote)
	*x.list = append(*x.list, concreteValue)
}

func (x *_Action_15_list) AppendMutable() protoreflect.Value {
	v := new(ActionVote)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Action_15_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_Action_15_list) NewElement() protoreflect.Value {
	v := new(ActionVote)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Action_15_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_Action_template           protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Action_template = md_Action.Fields().ByName("template")
...
func (x *fastReflection_Action) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Votes) != 0 {
		value := protoreflect.ValueOfList(&_Action_15_list{list: &x.Votes})
...
func (x *fastReflection_Action) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "warden.act.v1beta1.Action.template":
...
func (x *fastReflection_Action) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "warden.act.v1beta1.Action.votes":
		if len(x.Votes) == 0 {
			return protoreflect.ValueOfList(&_Action_15_list{})
		}
		listValue := &_Action_15_list{list: &x.Votes}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: warden.act.v1beta1.Action"))
...
func (x *fastReflection_Action) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "warden.act.v1beta1.Action.votes":
		...
		value := &_Action_15_list{list: &x.Votes}
		return protoreflect.ValueOfList(value)
	case "warden.act.v1beta1.Action.id":
...
func (x *fastReflection_Action) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "warden.act.v1beta1.Action.votes":
		list := []*ActionVote{}
		return protoreflect.ValueOfList(&_Action_15_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: warden.act.v1beta1.Action"))
		}
...
type Action struct {
	...
	ApproveExpression *ast.Expression `protobuf:"bytes,13,opt,name=approve_expression,json=approveExpression,proto3" json:"approve_expression,omitempty"`
	// The expression to be evaluated for rejection.
	RejectExpression *ast.Expression `protobuf:"bytes,14,opt,name=reject_expression,json=rejectExpression,proto3" json:"reject_expression,omitempty"`
...
func (x *Action) GetTemplate() *Template {
	if x != nil {
		return x.Template
	}
	return nil
...
var file_warden_act_v1beta1_action_proto_rawDesc = []byte{
	...
	0x1a, 0x21, 0x77, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x2f, 0x61, 0x63, 0x74, 0x2f, 0x76, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2f, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x1a, 0x24, 0x77, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x2f, 0x61, 0x63, 0x74, 0x2f,
	0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x76,
	0x6f, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x70, 0x0a, 0x08, 0x41, 0x70, 0x70,
	...
	0x0a, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x64, 0x41, 0x74, 0x22, 0xe3, 0x05, 0x0a, 0x06,
	...
	,
	...
	0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x02, 0x12, 0x19, 0x0a, 0x15, 0x41, 0x43, 0x54,
	0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x52, 0x45, 0x56, 0x4f, 0x4b,
	0x45, 0x44, 0x10, 0x03, 0x12, 0x19, 0x0a, 0x15, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53,
	0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x4f, 0x55, 0x54, 0x10, 0x04, 0x42,
	0xdc, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x77, 0x61, 0x72, 0x64, 0x65, 0x6e, 0x2e, 0x61,
	0x63, 0x74, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0b, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4b, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_warden_act_v1beta1_action_proto_goTypes = []interface{}{
	...
	(*Template)(nil),              // 5: warden.act.v1beta1.Template
	(*ast.Expression)(nil),        // 6: shield.ast.Expression
	(*ActionVote)(nil),            // 7: warden.act.v1beta1.ActionVote
}
var file_warden_act_v1beta1_action_proto_depIdxs = []int32{
	...
	5,  // 7: warden.act.v1beta1.Action.template:type_name -> warden.act.v1beta1.Template
	6,  // 8: warden.act.v1beta1.Action.approve_expression:type_name -> shield.ast.Expression
	6,  // 9: warden.act.v1beta1.Action.reject_expression:type_name -> shield.ast.Expression
	7,  // 10: warden.act.v1beta1.Action.votes:type_name -> warden.act.v1beta1.ActionVote
