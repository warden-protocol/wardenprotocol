	...
	info: (props: LucideProps) => (
		...
		>
			...
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
				d="M11.5 8C11.5 7.72386 11.7239 7.5 12 7.5H12.01C12.2861 7.5 12.51 7.72386 12.51 8C12.51 8.27614 12.2861 8.5 12.01 8.5H12C11.7239 8.5 11.5 8.27614 11.5 8Z"
				fill="white"
			/>
		</svg>
	),
