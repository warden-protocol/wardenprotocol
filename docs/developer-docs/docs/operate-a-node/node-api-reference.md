...
Warden Protocol nodes are central points of contact for the Warden Protocol. They're responsible for routing requests to [Keychain](/learn/glossary#keychain) and for routing responses back to the client.
