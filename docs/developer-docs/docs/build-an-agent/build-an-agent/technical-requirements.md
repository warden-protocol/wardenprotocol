...
To develop an Agent, use our CLI, [Warden Code](../warden-code/introduction). This ensures compatibility with Warden and provides everything you need to get started.
...
To [publish an Agent on Warden](../publish-on-warden), you only need the following:

- The **public URL** provided by your [hosting service](../host-your-agent).
- The **Agent API key** generated by Warden Code for [authentication](../warden-code/basics#api-key-authentication)
