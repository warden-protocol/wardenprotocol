...
// @generated from file wardenprotocol/treasury/signature.proto (package wardenprotocol.treasury, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum wardenprotocol.treasury.SignRequestStatus
 */
...
proto3.util.setEnumType(SignRequestStatus, "wardenprotocol.treasury.SignRequestStatus", [
...
/**
 * @generated from message wardenprotocol.treasury.SignRequest
 */
export class SignRequest extends Message<SignRequest> {
  ...
  /**
   * @generated from field: wardenprotocol.treasury.SignRequestStatus status = 5;
   */
  status = SignRequestStatus.UNSPECIFIED;

  /**
   * @generated from field: wardenprotocol.treasury.KeyType key_type = 8;
   */
   ...
   * the rejection.
   *
   * @generated from oneof wardenprotocol.treasury.SignRequest.result
   */
  result: {
    /**
  ...
  static readonly typeName = "wardenprotocol.treasury.SignRequest";
...
/**
 * @generated from message wardenprotocol.treasury.SignTransactionRequest
 */
export class SignTransactionRequest extends Message<SignTransactionRequest> {
  ...
  /**
   * @generated from field: wardenprotocol.treasury.WalletType wallet_type = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wardenprotocol.treasury.SignTransactionRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "creator", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "key_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
