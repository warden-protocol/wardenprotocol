...
func (s *utilsTestSuite) TestSortJSON() {
	cases := []struct {
		...
		// from the TXSpec:
		{
			unsortedJSON: `{"chain_id":"test-chain-1","sequence":1,"fee_bytes":{"amount":[{"amount":5,"denom":"qrdo"}],
...
"denom":"qrdo"}],"gas":10000},"msg_bytes":{"inputs":[{"address":"696E707574","coins":[{"amount":10,"denom":"atom"}]}],
