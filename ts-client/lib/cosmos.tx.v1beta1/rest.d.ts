...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    serviceTxDecode: (body: {
        tx_bytes?: string;
    }, params?: RequestParams) => Promise<AxiosResponse<TxDecodeResponse>>;
    /**
     * No description
     *
     * @tags Service
     ...
     */
    serviceTxEncode: (body: TxEncodeRequest, params?: RequestParams) => Promise<AxiosResponse<{
        tx_bytes?: string;
    }>>;
    /**
     * No description
     ...
     */
    serviceSimulate: (body: SimulateRequest, params?: RequestParams) => Promise<AxiosResponse<{
        gas_info?: {
            gas_wanted?: string;
            gas_used?: string;
        };
    ...
    serviceGetTxsEvent: (query?: {
        ...
        limit?: string;
        query?: string;
    }, params?: RequestParams) => Promise<AxiosResponse<GetTxsEventResponse>>;
    /**
     * No description
     *
     * @tags Service
    ...
    serviceGetBlockWithTxs: (height: string, query?: {
        ...
        "pagination.count_total"?: boolean;
        "pagination.reverse"?: boolean;
    }, params?: RequestParams) => Promise<AxiosResponse<GetBlockWithTxsResponse>>;
    /**
     * No description
     *
     * @tags Service
     ...
     */
    serviceGetTx: (hash: string, params?: RequestParams) => Promise<AxiosResponse<GetTxResponse>>;
}
