...
func (m *QueryInferenceRequestsRequest) Reset()         { *m = QueryInferenceRequestsRequest{} }
func (m *QueryInferenceRequestsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryInferenceRequestsRequest) ProtoMessage()    {}
func (*QueryInferenceRequestsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f988bcedf7389875, []int{25}
}
func (m *QueryInferenceRequestsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryInferenceRequestsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryInferenceRequestsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryInferenceRequestsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryInferenceRequestsRequest.Merge(m, src)
}
func (m *QueryInferenceRequestsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryInferenceRequestsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryInferenceRequestsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryInferenceRequestsRequest proto.InternalMessageInfo

func (m *QueryInferenceRequestsRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryInferenceRequestsResponse struct {
	Pagination        *query.PageResponse `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"`
	InferenceRequests []InferenceRequest  `protobuf:"bytes,2,rep,name=inference_requests,json=inferenceRequests,proto3" json:"inference_requests"`
}

func (m *QueryInferenceRequestsResponse) Reset()         { *m = QueryInferenceRequestsResponse{} }
func (m *QueryInferenceRequestsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryInferenceRequestsResponse) ProtoMessage()    {}
func (*QueryInferenceRequestsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f988bcedf7389875, []int{26}
}
func (m *QueryInferenceRequestsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryInferenceRequestsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryInferenceRequestsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryInferenceRequestsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryInferenceRequestsResponse.Merge(m, src)
}
func (m *QueryInferenceRequestsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryInferenceRequestsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryInferenceRequestsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryInferenceRequestsResponse proto.InternalMessageInfo

func (m *QueryInferenceRequestsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryInferenceRequestsResponse) GetInferenceRequests() []InferenceRequest {
	if m != nil {
...
func (m *QueryInferenceRequestByIdRequest) Reset()         { *m = QueryInferenceRequestByIdRequest{} }
func (m *QueryInferenceRequestByIdRequest) String() string { return proto.CompactTextString(m) }
func (*QueryInferenceRequestByIdRequest) ProtoMessage()    {}
func (*QueryInferenceRequestByIdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f988bcedf7389875, []int{27}
}
func (m *QueryInferenceRequestByIdRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryInferenceRequestByIdRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryInferenceRequestByIdRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryInferenceRequestByIdRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryInferenceRequestByIdRequest.Merge(m, src)
}
func (m *QueryInferenceRequestByIdRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryInferenceRequestByIdRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryInferenceRequestByIdRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryInferenceRequestByIdRequest proto.InternalMessageInfo

func (m *QueryInferenceRequestByIdRequest) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
type QueryInferenceRequestByIdResponse struct {
	InferenceRequest InferenceRequest `protobuf:"bytes,1,opt,name=inference_request,json=inferenceRequest,proto3" json:"inference_request"`
}

func (m *QueryInferenceRequestByIdResponse) Reset()         { *m = QueryInferenceRequestByIdResponse{} }
func (m *QueryInferenceRequestByIdResponse) String() string { return proto.CompactTextString(m) }
func (*QueryInferenceRequestByIdResponse) ProtoMessage()    {}
func (*QueryInferenceRequestByIdResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f988bcedf7389875, []int{28}
}
func (m *QueryInferenceRequestByIdResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryInferenceRequestByIdResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryInferenceRequestByIdResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryInferenceRequestByIdResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryInferenceRequestByIdResponse.Merge(m, src)
}
func (m *QueryInferenceRequestByIdResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryInferenceRequestByIdResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryInferenceRequestByIdResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryInferenceRequestByIdResponse proto.InternalMessageInfo

func (m *QueryInferenceRequestByIdResponse) GetInferenceRequest() InferenceRequest {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryInferenceRequestsRequest)(nil), "warden.warden.v1beta3.QueryInferenceRequestsRequest")
	proto.RegisterType((*QueryInferenceRequestsResponse)(nil), "warden.warden.v1beta3.QueryInferenceRequestsResponse")
	proto.RegisterType((*QueryInferenceRequestByIdRequest)(nil), "warden.warden.v1beta3.QueryInferenceRequestByIdRequest")
	proto.RegisterType((*QueryInferenceRequestByIdResponse)(nil), "warden.warden.v1beta3.QueryInferenceRequestByIdResponse")
}
...
var fileDescriptor_f988bcedf7389875 = []byte{
	...
	,
}
...
func (c *queryClient) InferenceRequests(ctx context.Context, in *QueryInferenceRequestsRequest, opts ...grpc.CallOption) (*QueryInferenceRequestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/warden.warden.v1beta3.Query/InferenceRequests", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) InferenceRequestById(ctx context.Context, in *QueryInferenceRequestByIdRequest, opts ...grpc.CallOption) (*QueryInferenceRequestByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/warden.warden.v1beta3.Query/InferenceRequestById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) InferenceRequests(ctx context.Context, req *QueryInferenceRequestsRequest) (*QueryInferenceRequestsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InferenceRequests not implemented")
}
func (*UnimplementedQueryServer) InferenceRequestById(ctx context.Context, req *QueryInferenceRequestByIdRequest) (*QueryInferenceRequestByIdResponse, error) {
...
func _Query_InferenceRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/warden.warden.v1beta3.Query/InferenceRequests",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_InferenceRequestById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/warden.warden.v1beta3.Query/InferenceRequestById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryInferenceRequestsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryInferenceRequestsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryInferenceRequestsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryInferenceRequestsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryInferenceRequestsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryInferenceRequestsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryInferenceRequestByIdRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryInferenceRequestByIdRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryInferenceRequestByIdRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryInferenceRequestByIdResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryInferenceRequestByIdResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryInferenceRequestByIdResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryInferenceRequestsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryInferenceRequestsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryInferenceRequestByIdRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryInferenceRequestByIdResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryInferenceRequestsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryInferenceRequestsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryInferenceRequestsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryInferenceRequestsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryInferenceRequestsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryInferenceRequestsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.InferenceRequests = append(m.InferenceRequests, InferenceRequest{})
...
func (m *QueryInferenceRequestByIdRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryInferenceRequestByIdRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryInferenceRequestByIdRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryInferenceRequestByIdResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryInferenceRequestByIdResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryInferenceRequestByIdResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
