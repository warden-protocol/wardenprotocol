...
import (
	...
	types "github.com/qredo/fusionchain/x/treasury/types"
...
type MsgMint struct {
	...
	WalletType        types.WalletType `protobuf:"varint,3,opt,name=wallet_type,json=walletType,proto3,enum=fusionchain.treasury.WalletType" json:"wallet_type,omitempty"`
...
func (m *MsgMint) GetWorkspaceAddr() string {
	if m != nil {
...
func (m *MsgMint) GetWalletType() types.WalletType {
	if m != nil {
		return m.WalletType
	}
...
func (m *MsgBurn) GetWorkspaceAddr() string {
	if m != nil {
		return m.WorkspaceAddr
	}
	return ""
...
func (m *MsgBurn) GetWalletType() types.WalletType {
	if m != nil {
		return m.WalletType
	}
	return types.WalletType_WALLET_TYPE_UNSPECIFIED
...
var fileDescriptor_cabd3285a4bd8dc4 = []byte{
	...
	,
}
