...
import (
	...
	wardentestutil "github.com/warden-protocol/wardenprotocol/warden/x/warden/testutil"
)
...
type AnteTestSuite struct {
	...
	bankKeeper     *wardentestutil.MockBankKeeper
...
func SetupTestSuite(t *testing.T, isCheckTx bool) *AnteTestSuite {
	...
	suite.bankKeeper = wardentestutil.NewMockBankKeeper(ctrl)
