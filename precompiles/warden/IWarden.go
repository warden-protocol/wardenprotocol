...
//
// Solidity: function signRequestById(uint64 id) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],uint8) signRequest)
...
// SignRequests is a free data retrieval call binding the contract method 0xf23b9530.
//
// Solidity: function signRequests((bytes,uint64,uint64,bool,bool) pageRequest, uint64 keychainId, int32 status, uint8 broadcastType) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],uint8)[] signRequests, (bytes,uint64) pageResponse)
func (_IWarden *IWardenCaller) SignRequests(opts *bind.CallOpts, pageRequest TypesPageRequest, keychainId uint64, status int32, broadcastType uint8) (struct {
...
//
// Solidity: function signRequests((bytes,uint64,uint64,bool,bool) pageRequest, uint64 keychainId, int32 status, uint8 broadcastType) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],uint8)[] signRequests, (bytes,uint64) pageResponse)
func (_IWarden *IWardenSession) SignRequests(pageRequest TypesPageRequest, keychainId uint64, status int32, broadcastType uint8) (struct {
	SignRequests []SignRequest
	PageResponse TypesPageResponse
}, error) {
...
//
// Solidity: function signRequests((bytes,uint64,uint64,bool,bool) pageRequest, uint64 keychainId, int32 status, uint8 broadcastType) view returns((uint64,address,uint64,bytes,int32,bytes,bytes,(string,uint256)[],uint8)[] signRequests, (bytes,uint64) pageResponse)
func (_IWarden *IWardenCallerSession) SignRequests(pageRequest TypesPageRequest, keychainId uint64, status int32, broadcastType uint8) (struct {
	SignRequests []SignRequest
	PageResponse TypesPageResponse
}, error) {
	return _IWarden.Contract.SignRequests(&_IWarden.CallOpts, pageRequest, keychainId, status, broadcastType)
