...
init_func() {
    "$PWD"/build/wardend keys add $KEY"$i" --keyring-backend test --home "$DATA_DIR$i" --no-backup --algo "eth_secp256k1"
    ...
    "$("$PWD"/build/wardend keys show "$KEY$i" --keyring-backend test -a --home "$DATA_DIR$i")" 1000000000000000000nward,1000000000000000000stake \
    --keyring-backend test --home "$DATA_DIR$i"
    "$PWD"/build/wardend gentx "$KEY$i" 1000000000000000000stake --chain-id $CHAINID --keyring-backend test --home "$DATA_DIR$i"
