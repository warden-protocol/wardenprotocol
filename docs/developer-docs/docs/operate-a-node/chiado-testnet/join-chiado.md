...
1. Download the binary for your platform from the [release page](https://github.com/warden-protocol/wardenprotocol/releases/tag/v0.6.1) and unzip it. The archive contains the `wardend` binary.
