...
docker tag mpc-relayer 532153175488.dkr.ecr.eu-west-1.amazonaws.com/qredo/production/mpc-relayer:${commit_hash_short}
docker push 532153175488.dkr.ecr.eu-west-1.amazonaws.com/qredo/production/mpc-relayer:latest
docker push 532153175488.dkr.ecr.eu-west-1.amazonaws.com/qredo/production/mpc-relayer:${commit_hash_short}