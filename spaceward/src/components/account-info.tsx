...
function AccountInfo() {
    ...
    const bq = useQuery({
        ...
        queryFn: () => balances(address),
    });
    const denom =
        bq.data?.balances.find((b) => b.denom === "uward")?.amount || "0";
            ...
            >
                <span className="flex items-center flex-1 min-w-0 space-x-2">
                    ...
                    <span className="flex-1 block min-w-0">
                        <span className="block text-sm text-gray-900 truncate font-display">
                            {address}
                        </span>
                        <span className="block text-sm text-gray-500 truncate font-display">
                            {ward.toFixed(2)} WARD
                        </span>
                    </span>
                </span>
                    ...
                    <div className="fixed inset-0 w-screen overflow-y-auto">
                      ...
                      <CheckIcon className="w-6 h-6 text-green-600" aria-hidden="true" />
                                        ...
                                        <div className="mt-3 text-center sm:mt-5">
                                            <Dialog.Title
                                                as="h3"
                                                className="text-xl leading-6 font-display"
                                            >
                                                {address}
                                            </Dialog.Title>
