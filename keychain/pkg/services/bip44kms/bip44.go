...
type Keychain interface {
	PublicKey(keyID []byte, cryptoSystem CryptoSystem) ([]byte, error)
	PubkeySignature(keyID []byte, cryptoSystem CryptoSystem) ([]byte, error)
	Signature(sigRequestData *SigRequestData, cryptoSystem CryptoSystem) ([]byte, []byte, error)
}
...
// NewBip44Keychain returns a Bip44Keychain with masterseed and chaincode
func NewBip44Keychain(seedPhrase, password string) (*Bip44Keychain, error) {
...
func (k *Bip44Keychain) PublicKey(keyID []byte, cryptoSystem CryptoSystem) (pubKey []byte, err error) {
...
func (k *Bip44Keychain) PubkeySignature(keyID []byte, cryptoSystem CryptoSystem) (sig []byte, err error) {
	derivationPath, err := derivationPathFromKeyID(keyID)
	if err != nil {
		return nil, err
	}
...
func (k *Bip44Keychain) Signature(sigRequestData *SigRequestData, cryptoSystem CryptoSystem) (sig []byte, pubKey []byte, err error) {
