        ...
        <div className="hidden h-full flex-1 flex-col space-y-8 p-8 md:flex">
            <Breadcrumb>
                ...
                <BreadcrumbItem isCurrentPage>
                    <BreadcrumbLink to={`/spaces/${spaceId}`}>
                        Space {spaceId}
                    </BreadcrumbLink>
                </BreadcrumbItem>
            </Breadcrumb>
                        ...
                        <ul className="flex flex-col space-y-1">
                            {space.owners.map((owner) => (
                                ...
                                >
                                    ...
                                    <Button
                                        variant="destructive"
                                        className="opacity-20 px-2 py-0.5 ml-2 h-auto w-auto group-hover:opacity-100"
                                        onClick={() => {
                                            monitorTx(
                ...
                <CardContent>
                    {keychainId ? (
                        <>
                            ...
                            >
                                <span>Request a new key</span>
                                <span className="text-xs">({keychainId})</span>
                            </Button>
                            <KeyRequestDialog
                                state={state}
                                error={error}
                        ...
                        <Link to={`/keychains`}>
                            <Button>Select a keychain</Button>
                        </Link>
                    )}
