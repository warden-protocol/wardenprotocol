...
export declare const ListAllInterfacesResponse: {
    ...
    } & { [K_1 in Exclude<keyof I, "interfaceNames">]: never; }>(object: I): ListAllInterfacesResponse;
};
export declare const ListImplementationsRequest: {
    ...
    fromPartial<I extends {
        ...
        interfaceName?: string | undefined;
    } & { [K in Exclude<keyof I, "interfaceName">]: never; }>(object: I): ListImplementationsRequest;
};
export declare const ListImplementationsResponse: {
    ...
    } & { [K_1 in Exclude<keyof I, "implementationMessageNames">]: never; }>(object: I): ListImplementationsResponse;
};
