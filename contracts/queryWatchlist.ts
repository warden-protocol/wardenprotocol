...
(async function main() {
    ...
    const contractAddress = "qredo14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9ss9tga8"

    const q1 = await client.queryContractSmart(contractAddress, {get_watchlist:{}})
    console.log(q1)
    const q2 = await client.queryContractSmart(contractAddress, {get_balances:{}})
    console.log(q2)
})();
