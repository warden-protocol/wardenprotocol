...
export { MsgConnectionOpenInit, MsgConnectionOpenConfirmResponse, ClientPaths, MsgConnectionOpenAck, QueryConnectionResponse, MsgConnectionOpenTryResponse, GenesisState, IdentifiedConnection, Params, QueryConnectionRequest, MsgConnectionOpenAckResponse, Version, QueryConnectionConsensusStateResponse, QueryConnectionsResponse, QueryConnectionParamsResponse, MsgConnectionOpenTry, MsgUpdateParams, QueryConnectionClientStateResponse, QueryConnectionConsensusStateRequest, ConnectionEnd, QueryConnectionClientStateRequest, QueryConnectionParamsRequest, MsgConnectionOpenInitResponse, MsgUpdateParamsResponse, QueryClientConnectionsResponse, Counterparty, ConnectionPaths, MsgConnectionOpenConfirm, QueryConnectionsRequest, QueryClientConnectionsRequest };
