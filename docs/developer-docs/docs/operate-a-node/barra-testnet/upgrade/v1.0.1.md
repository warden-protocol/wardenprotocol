...
1. Download the [wardend binary v1.0.1](https://github.com/warden-protocol/wardenprotocol/releases/tag/v1.0.1) or build it from the source code. See the installation instructions in the [Join Barra guide](../join-barra#1-install-the-binary).

2. Run Warden v0.7.6 until the upgrade height. The node will panic:

   ```shell
   ERR UPGRADE "v1.0.1" NEEDED at height: 4619000: upgrade to v1.0.1 and applying upgrade "v1.0.1" at height: 4619000
   ```
