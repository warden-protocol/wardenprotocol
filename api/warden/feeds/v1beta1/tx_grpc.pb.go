...
const (
	Msg_UpdateParams_FullMethodName = "/warden.feeds.v1beta1.Msg/UpdateParams"
	Msg_AddFeed_FullMethodName      = "/warden.feeds.v1beta1.Msg/AddFeed"
)
...
func (c *msgClient) AddFeed(ctx context.Context, in *MsgAddFeed, opts ...grpc.CallOption) (*MsgAddFeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AddFeed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
