 ...
 */
export declare class MsgDepositValidatorRewardsPool extends Message<MsgDepositValidatorRewardsPool> {
  /**
 ...
 */
export declare class MsgDepositValidatorRewardsPoolResponse extends Message<MsgDepositValidatorRewardsPoolResponse> {
