...
import (
	...
	ethermintclient "github.com/sashaduke/fusion/client"
	"github.com/sashaduke/fusion/client/debug"
	"github.com/sashaduke/fusion/crypto/hd"
	"github.com/sashaduke/fusion/encoding"
	"github.com/sashaduke/fusion/server"
	servercfg "github.com/sashaduke/fusion/server/config"
...
func (a appCreator) appExport(
	...
	if height != -1 {
		ethermintApp = app.NewEthermintApp(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg,
			nil, appOpts, nil)
		...
		ethermintApp = app.NewEthermintApp(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg,
			nil, appOpts, nil)
	}
