...
func TestAddressFormats(t *testing.T) {
	testCases := []struct {
		...
		{"Qredo Address", "qredo18wvvwfmq77a6d8tza4h5sfuy2yj3jj88mhw6s0", "0x3B98c72760f7BBa69D62ED6f48278451251948e7", false},
		...
		{"invalid Qredo address", "qredo18wvvwfmq77a6d8tza4h5sfuy2yj3jj88", "", true},
		{"empty string", "", "", true},
	}
